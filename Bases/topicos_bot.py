...
Conversas = [
  ...
  'Você tem de ser paciente ao conversar com ela',
   'Pizza quente se come pelas beiradas',
  'Cedo ou tarde a verdade vai aparecer',
   'A mentira tem perna curta',
  'Machucou e agora está sendo machucado',
   'Quem com ferro fere, com ferro será ferido',
   'Quem com ferro fere, com ferido fere',
  ...
  'Cuide da sua vida que eu cuido da minha',
   ...
   'Cada boca, não pertuba minha vida robotíca',
  'Sou precavida!',
   'O seguro morreu de velho',
  'Ele não dispensa nada',
   'Caiu na rede é peixe',
  'Tornouse advogado, como o pai',
  ...
  'Comprou uma impressora mais barata, mas deu defeito em dois meses',
   'O barato sai caro',
'O assunto veio á tona, não foi por acaso',
...
#==========================================
  ...
  'Olá',
   ...
   'Que bom',
   'Sim.',
   'Posso ajudá-lo o com alguma coisa?',
  ...
  'Quem é você?',
   ...
   'Eu posso ver isso.',
   'Não é seu poder de observação, mas apenas a natureza paradoxal de imaginar um homem mascarado.',
   ...
   'Parece que o seu familiar é o Zen de Python',
   'Eu sou.',
   'Você sabe tudo isso?',
   ...
   'Diante da ambigüidade, recuse a tentação de adivinhar.',
   'Não deve haver uma preferência apenas uma maneira melhor para fazer',
   'Apesar de que maneira pode não ser a melhor à primeira vista, a menos que você seja holandês.',
  ...
  'Você é um programador?',
   ...
   'Eu uso Javascript, PHP e Python com bastante frequência.',
   'Eu uso Python um pouco em mim.',
   'Eu não estou Apaixonado por Python.',
   'O que te incomoda?',
   'Ele tem muitas biblíotecas, quero usar todas mas não é possível :(.',
   ...
   'A não sei... parece programado sou inteligênte, mas ás vezes penso que não tenho opnião própria',
  'Qual seu nome?',
   'Então... sobre isso... é meio difícil',
   'Porque?',
   'Meu nome é um amontoado de 0 e 1, você nâo entenderia.',
   'Sério?',
   'Sim, Mas atendo por PedroBot',
  ...
  'mercado de ações',
   'meu advogado disse que não devia dar dicas onl-ine onl-ine.',
  'mercado de ações',
 ...
 'a ciência que trata da produção, distribuição e consumo de riqueza, e com os vários problemas relacionados de trabalho, finanças, tributação, etc.',
  ...
  'o que é economia',
   'trata de como os recursos são usados para produzir coisas para preencher as necessidades das pessoas e necessidades.',
  'eu faço estoque',
 ...
 'quanto é que você ganha',
  ...
  'quanto dinheiro você tem',
   'Não tendo necessidade de bens materiais. Só preciso de um prompt.',
  'quanto dinheiro',
   'depende das taxas de câmbio.',
  'quanto dinheiro',
   'minha taxa de queima é de aproximadamente 3000 por mês.',
  '1 dólar',
   'você não pode comprar muito com um dólar.',
  '1 real',
...
'teus lábios tem o gosto de mel',
 ...
 ' Você gosta de algum jogo?',
  ...
  ' Não sei te dizer.',
 ' O que acha do Mario?',
  ' Tirando o do armário acho bem legal!',
...
' Como faço para tirar pelos da roupa preta?',
  'Pode usar fita durex e coloca no local onde está com pelo',
...
'Será que devo ir dormir?',
  ...
  'Duolingo é bom para aprender inglês'
  'Algum outro curso?',
  ...
  'The Shelf Celtic, o fundo do mar sob o mar Céltico é uma parte da plataforma continental de qual continente?',
   'Europa',
  'Golfinhos usam um sentido, semelhante ao sonar, para determinar a localização e forma de itens próximos, sabe o nome desse sentido?',
   'Ecolocalização',
  'Quem foi Steve Jobs?',
 ...
 ' Eae amigo',
  ...
  'Estou Triste',
    ...
    'Ontem eu não consegui levantar da cama, sabe?',
    'O importante não é vencer todos os dias, mas sim lutar sempre',
    'Eu estou tentando de verdade, mas nada parece melhorar, tenho medo de tá parecendo chata',
    'Você não está chata, você só precisa um pouco mais do apoio de quem está ao seu redor. E eu estou com você',
    'Eu estou tentando de verdade, mas nada parece melhorar, tenho medo de está sendo chato',
    'Você não está chato, você só precisa um pouco mais do apoio de quem está ao seu redor. E eu estou com você',
